...
const COUNTRY_ISO_MAP: Record<string, string> = {
  ...
  "portugal": "PRT", "taiwan": "TWN", "singapore": "SGP", "panama": "PAN", "hungary": "HUN",
  ...
  "ireland": "IRL", "slovakia": "SVK",
  "lithuania": "LTU", "latvia": "LVA", "slovenia": "SVN",
  "luxembourg": "LUX", "iceland": "ISL",
  "bosnia-and-herzegovina": "BIH", "moldova": "MDA", "belarus": "BLR",
};
...
const COUNTRY_CENTROIDS: Record<string, [number, number]> = {
  ...
  PRT: [39.4, -8.2], TWN: [23.7, 121.0], SGP: [1.35, 103.8], PAN: [8.5, -80.8], HUN: [47.2, 19.5],
  CZE: [49.8, 15.5], BGR: [42.7, 25.5], SRB: [44.0, 21.0], HRV: [45.1, 15.2],
  GEO: [42.1, 43.4], EST: [58.7, 25.0], GRC: [39.1, 21.8], ARE: [24.3, 54.4],
  MUS: [-20.2, 57.5], CYP: [35.1, 33.4], MLT: [35.9, 14.4], MNE: [42.8, 19.3],
  ALB: [41.1, 20.0], MKD: [41.6, 21.7], LKA: [7.9, 80.7], LAO: [19.9, 102.6],
  ECU: [-1.8, -78.2], GTM: [15.8, -90.2], PRY: [-23.4, -58.4], URY: [-32.5, -55.8],
  CUB: [21.5, -79.5], JAM: [18.1, -77.3],
  NLD: [52.1, 5.3], BEL: [50.5, 4.5], AUT: [47.5, 14.6],
  CHE: [46.8, 8.2], NOR: [60.5, 8.5], DNK: [56.3, 9.5], FIN: [64.0, 26.0],
  IRL: [53.4, -8.2], SVK: [48.7, 19.7],
  LTU: [55.2, 24.0], LVA: [56.9, 24.6], SVN: [46.1, 14.8],
  LUX: [49.8, 6.1], ISL: [64.9, -19.0],
  BIH: [43.9, 17.9], MDA: [47.4, 28.4], BLR: [53.7, 27.9],
};
