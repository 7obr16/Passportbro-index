...
const PORTRAIT_AVAILABLE = new Set([
  ...
  "british-indian-ocean-territory", "austria", "switzerland", "netherlands",
  "belgium", "finland", "slovakia", "lithuania", "latvia", "luxembourg",
  "iceland", "bosnia-and-herzegovina", "moldova", "denmark", "slovenia",
  "ireland", "norway",   "kiribati", "zimbabwe", "ghana", "north-korea",
  "jordan", "san-marino", "ivory-coast", "dominica", "djibouti", "anguilla",
  "solomon-islands", "togo", "martinique", "christmas-island", "israel",
  "new-zealand", "yemen", "antigua-and-barbuda", "saint-barthelemy", "fiji",
  "myanmar", "sao-tome-and-principe", "madagascar", "tuvalu", "guernsey",
  "cocos-keeling-islands", "kyrgyzstan", "tunisia", "american-samoa",
  "united-states-minor-outlying-islands", "oman", "french-polynesia",
  "falkland-islands", "saint-martin", "suriname", "azerbaijan", "palestine",
  "cayman-islands", "saint-lucia", "armenia", "papua-new-guinea", "samoa",
  "gambia", "guam", "liechtenstein", "senegal", "united-kingdom",
  "caribbean-netherlands", "french-guiana", "qatar", "isle-of-man",
  "antarctica", "western-sahara", "nauru",
  "saint-helena-ascension-and-tristan-da-cunha", "cook-islands",
  "pitcairn-islands", "new-caledonia", "mozambique", "bahamas",
  "marshall-islands", "maldives", "niue", "syria", "turkmenistan",
  "wallis-and-futuna", "brunei", "uzbekistan", "guyana", "tonga", "bermuda",
  "vatican-city", "barbados", "mali", "guadeloupe", "montserrat", "niger",
  "equatorial-guinea", "iraq", "mauritania", "puerto-rico", "sierra-leone",
  "mayotte", "jersey", "faroe-islands", "greenland", "hong-kong", "malawi",
  "honduras", "aruba", "monaco", "bouvet-island", "zambia", "andorra",
  "seychelles", "british-virgin-islands", "svalbard-and-jan-mayen", "kuwait",
  "namibia", "tajikistan", "vanuatu", "palau", "bhutan", "dr-congo", "eritrea",
  "gibraltar", "gabon", "curacao", "lesotho", "nicaragua", "kosovo",
  "trinidad-and-tobago", "haiti", "french-southern-and-antarctic-lands",
  "tokelau", "somalia", "macau", "sudan", "eswatini", "sint-maarten",
  "bangladesh", "saint-pierre-and-miquelon", "guinea", "micronesia", "grenada",
  "nepal", "south-sudan", "guinea-bissau", "lebanon", "norfolk-island",
  "afghanistan", "united-states", "south-georgia", "el-salvador",
  "northern-mariana-islands", "comoros", "turks-and-caicos-islands", "bahrain",
  "saint-kitts-and-nevis", "liberia", "united-states-virgin-islands", "reunion",
  "saint-vincent-and-the-grenadines", "republic-of-the-congo",
